// Adafruit IO REST API access with Particle
//
// For use with Particle Arduino from:
//   https://github.com/sparkp
//
...
#define AIO_KEY    "3a3688bc5a6f46da9c5281823032892f"
...
Adafruit_IO_Feed testFeed = aio.getFeed("particletestfeed");

// Alternatively to access a feed with a specific key:
//Adafruit_IO_Feed testFeed = aio.getFeed("particletestfeed", "...particletestfeed key...");
